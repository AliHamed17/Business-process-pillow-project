...
## External review prompt (Antigravity)
- Use `docs/ANTIGRAVITY_REVIEW_PROMPT.md` for a full copy/paste review prompt covering what to test and check across environment setup, CLI behavior, end-to-end execution, artifacts, reports, and maintainability.
